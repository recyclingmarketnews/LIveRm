...
<?php $__env->startSection('title-description'); ?>
        <title><?php echo e(substr($newsdetails->heading,0,50)); ?>..</title>
        <meta name="description" content="<?php echo substr(strip_tags($newsdetails->description),0,155); ?>.." />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                             ...
                                             <small class="paragraphcolortext d-block"><?php echo e($userdata->fname.' '.$userdata->lname); ?></small>
                                                    ...
                                                    <p class="fontsize14"><?php echo substr($newsdetails->description,0,200); ?></p>
                                                    <div class="mb-3">
                                                        <a target="_blank" href="<?php echo e(URL::to('signupselect')); ?>"><strong style="color: #1abe7f;">Read More</strong></a>
                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layouts.appp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wu6wt82f25ae/public_html/recyclingmarketnews.com/resources/views/dashboard/posts/sharesinglenews.blade.php ENDPATH**/ ?>