...
<body class="page-overview ac-gn-current-overview">
  <div class="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav justify-content-center w-100">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(URL::to('pricing')); ?>">Pricing</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="carousel-inner">
                            <div class="hero-copy large-10 large-centered medium-12">
                                <div class="carousel-item active">
                                    ...
                                    <a href="<?php echo e(URL::to('signupselect')); ?>" style="color:white; display: block;"><button class="button-news button-grand button-trial-download">
	...
	Try 14 days free</button><span style="color: black;font-size: 10px;">No Credit Card Required</span></a>
                    ...
                    <div class="banner-content">
                      <img class="img-fluid" src="<?php echo e(asset('front/images/logo.png')); ?>" width="350px">
                        <div class="banner-copy-container row justify-content-center" style="margin-top: 24px !important;">
                            ...
                            <p>$19.99 Per Month</p>
                            <p>or $227 Per Year</p>
                            <a href="<?php echo e(URL::to('signupselect')); ?>" style="    width: 206px;" class="icon-wrapper button-appleone button-news button-grand">
                                <span class="icon-copy" data-aos="fade-up" data-aos-anchor-placement="top-bottom">Try 14 days free</span></a>
                                <span style="color: black;font-size: 10px;">No Credit Card Required</span>
                                </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="single-footer footer-one">
                        ...
                        <ul class="bottom_links list-unstyled m-0">
                            ...
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('pricing')); ?>">Pricing</a></li>
                            <li class="nav-item"><a href="<?php echo e(URL::to('term')); ?>" class="nav-link">Terms & Conditions</a></li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="single-footer footer-one">
                        ...
                        <span style="font-weight: 700;">Global Recycling Market LTD</span> and/or its licensors, and are protected. Any unauthorized use or reproduction or distribution, shall attract suitable action under applicable law. Prices of currencies & commodities might be delayed; please read Disclaimer.</p>
...
</html><?php /**PATH /home/wu6wt82f25ae/public_html/recyclingmarketnewstrial.com/resources/views/home.blade.php ENDPATH**/ ?>