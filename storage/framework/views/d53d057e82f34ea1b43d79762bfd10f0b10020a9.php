                        ...
                        <div class="row">
                            <div class="col-12" style="padding: 20px; background-color: white; border-radius: 10px;">
                                <div class="page-title-box justify-content-between">
                                    <h4 align="center" >What can I publish?</h4>
                                ...
                                <p style="background: #d6ece7; padding: 15px;">For example, if you are an individual recycler with extensive knowledge of the Waste Management and recycling industry or you are a key stakeholder in other services which supports the recycling industry -  you may be interested in publishing opinions about Market trends, price fluctuations, future demand for specific materials, key regulations, compliance schemes, virgin polymers demand and pricing situation, freight and transport update, packaging, climate change, ocean clean-up initiatives, forex or any other current issues affecting the industry.</p>
                                ...
                                <br>
                                <p style="background:#d6ece7;padding: 15px;"><span style="font-weight: bold;">Individual:</span> Publish your own opinion about supply, demand, pricing forecast, climate change, ocean clean-up initiatives, currency effects on market, freight updates, regulation and compliance scheme update etc. In simple terms you can publish anything which doesn’t include any sort of marketing of any product or services.</p>
                                
                                <p style=" font-style: italic; padding-left:30px;">Conditions: Follow our basic community guidelines, No repetitive article within 14 days of same topic, Photos used in your article should be of your own ownership or purchased with license to protect the copyrights of the owner, any legal or government related updates requires a valid web link to be included in your article.</p>
                                <br>
                                <p style="background: #d6ece7;padding: 15px;"><span style="font-weight: bold;">Commercial:</span> Publish everything as an individual package. Additionally, any marketing such as press releases, announcements about new product launches, business updates, business acquisition or investments announcement, upcoming tender, close loop partnerships or any other relevant information related to your company's work in the field.</p>
                                
                                <p style=" font-style: italic; padding-left:30px;">Conditions: Follow our basic community guidelines, No repetitive article within 14 days of same topic, maximum 4 marketing related article is allowed monthly for promoting your business or product, Photos used in your article should be of your own ownership or purchased with license to protect the copyrights of the owner, any legal or government related updates requires a valid web link to be included in your article.</p>
                                <p>Please see our <a href="<?php echo e(URL::to('pricing')); ?>" class="fw-medium text-success">pricing page</a> for subscription plan options</p>
                                <br>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wu6wt82f25ae/public_html/recyclingmarketnewstrial.com/resources/views/dashboard/what-can-publish.blade.php ENDPATH**/ ?>