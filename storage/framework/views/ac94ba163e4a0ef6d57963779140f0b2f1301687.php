                                    ...
                                    <div class="col-xl-4 mb-3">
                                        <div class="mb-5">
                                            <label class="mb-2 fontsize14 form-label">Post Image1</label>
                                              <div>
                                                <div id="imgpre2"><img src="<?php echo e(asset('uploads/post/'.$postdata->image)); ?>" /></div>
                                        ...
                                        <div class="row">
    										...
    										<div class="col-lg-6 mb-3">
    											...
    											<select class="form-select" name="country"> 
    												...
    												<option value="<?php echo e($key->nicename); ?>" <?php if($key->nicename == $postdata->country): ?> selected <?php endif; ?>><?php echo e($key->nicename); ?></option>
    												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    													N/A
    												<?php endif; ?>
    											</select> 
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wu6wt82f25ae/public_html/test.recyclingmarketnews.com/resources/views/dashboard/posts/edit.blade.php ENDPATH**/ ?>