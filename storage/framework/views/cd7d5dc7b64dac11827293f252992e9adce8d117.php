                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 mb-3">
                                        ...
                                        <div class="col-xl-12 mb-3">
                                            ...
                                            <?php if(Auth::user()->user_value == 'company' and $totalcredit < 4): ?>
                                            ...
                                            <label for="vehicle1" style="margin-top:10px;">Marketing Post<span class="badge badge-soft-success font-size-10" style="margin-left: 10px;"><?php echo e($totalcredit); ?>/4 monthly credits used.</span></label>
                                            <?php endif; ?>
                                            </div>
                                        </div>
...
<script>
    $("#creditpost").change(function(){
          ...
          if(value == 1){
              alert("Please Upgrade Your Trial Version to Paid Version Before Using Free Credit. Thanks.");
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wu6wt82f25ae/public_html/recyclingmarketnewstrial.com/resources/views/dashboard/posts/add.blade.php ENDPATH**/ ?>