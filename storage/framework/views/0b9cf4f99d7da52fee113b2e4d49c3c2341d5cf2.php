                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">My Following List</h4>
                                </div>
                            </div>
                        </div>
				<!-- breadcrumb -->
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 p-3">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $followlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <?php   $uid = $key->publisherid;
                     
                                $rating = DB::select("SELECT ifnull(round(avg(ifnull(rating.value,0)),1),0) as ratingval FROM news_list
                        ...
                        ?>               
                           <div class="card me-2 p-3" style="width:100%; margin-top:10px;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-12 col-sm-12" style="margin-bottom: 5px; padding-left: 0;">
                                        <div class="d-flex  align-items-center">
                                            ...
                                            <span><a style="color:<?php if($mode == 'light'){ echo '#464545'; }else{ echo '#fff'; } ?>;font-size: 14px;font-weight: bold;" href="<?php echo e(URL::to('viewprofile/'.$userdata->id)); ?>" class="mb-1"><?php echo e($userdata->fname.' '.$userdata->lname); ?> </a> </span>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-12 col-sm-12" style="margin-bottom: 5px; padding-left: 0;">
                                        <div class="d-flex  align-items-center">
                                            <span class="stars me-1 font-size-10" data-rating="<?php echo e($rating[0]->ratingval); ?>" data-num-stars="5" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="hover focus" data-bs-content="<?php echo e($rating[0]->ratingval); ?> out of 5"></span> <span class="font-size-10">(<?php echo e($rating[0]->ratingval); ?>)</span>
                                            ...
                                            <span class="badge badge-soft-primary tooltipp  font-size-10" style="margin-left: 10px;">
                                                <?php $specialarray = json_decode($userdata->specialist); $c = count($specialarray); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wu6wt82f25ae/public_html/test.recyclingmarketnews.com/resources/views/dashboard/myfollows.blade.php ENDPATH**/ ?>