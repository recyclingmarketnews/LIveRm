...
<div class="main-content">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-xl-12">
                                <div class="card overflow-hidden">
                                    <div class="profile-user" style="padding:0 !important;">  <img src="<?php echo e(asset('uploads/userbimg/'.$data->bimage)); ?>" alt="" style="width: 950px;padding:0 !important;height:auto;" class="avatar-lg img-fluid"> </div>
                                    <div class="card-body">
                                        <div class="profile-content">
                                            ...
                                            <div>
                                                <!--<span><a class="badge badge-soft-success" href="<?php echo e(URL::to('chat/'.$data->id)); ?>">Message</a></span>-->
                                            ...
                                            <?php endif; ?>
                                                ...
                                                <p class="text-muted mb-1"><?php echo e($data->bio); ?></p>
                                                    ...
                                                    <a href="<?php echo e(URL::to('chat/'.$data->id)); ?>" class="btn btn-success btn-sm" style="border-radius:34px">Message</a>
                                                    <?php else: ?>
                                        ...
                                        <div class="tab-pane active" id="about" role="tabpanel">
                                            <div>
                                                <div>
                                                    ...
                                                    <ul class="activity-feed mb-0 ps-2" style="display:flex;">
                                                        <li class="feed-item border-0"><a href="<?php echo e($data->website_address); ?>" target="_blank"><?php echo e($data->website_address); ?></a></li>
                                                    </ul>
            ...
            <div class="col-xl-12 col-lg-12 card p-3" style="margin-top: 10px;">
                <h5 class="font-size-16 ">User Posts (<?php echo e($totalpostcount); ?>)</h5>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wu6wt82f25ae/public_html/test.recyclingmarketnews.com/resources/views/dashboard/profileview.blade.php ENDPATH**/ ?>