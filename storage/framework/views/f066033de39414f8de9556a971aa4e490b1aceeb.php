	...
	<ul class="metismenu list-unstyled" id="side-menu">
		...
		<li>
			<a href="javascript: void(0);" class="has-arrow">
				...
				<span class="menu-item" data-key="t-email">Categories</span>
			</a>
		...
		<li>
			...
			<ul class="sub-menu" aria-expanded="false">
				<li><a href="<?php echo e(URL::to('addpost')); ?>" data-key="t-inbox">Add Post</a></li>
...
</div><?php /**PATH /home/wu6wt82f25ae/public_html/globalrecyclingnews.net/resources/views/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>