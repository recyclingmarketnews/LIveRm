                                            ...
                                            <div class="col-lg-7">
                                                <div class="title">
                                                   ...
                                                   <a href="#"><span class="badge badge-soft-warning  font-size-10" style="margin-left: 10px;" ><?php echo e($userdata->country); ?></span></a>
                                                    ...
                                                    <p>Published date: <?php echo e($new_date = date('Y-m-d', strtotime($newsdetails->created_at))); ?></p>
                                                          ...
                                                          <div class="modal-dialog">
                                                            <div class="modal-content">
                                                              ...
                                                              <div class="modal-body">
                                                                    <input type="text" class="form-control" value="https://recyclingmarketnewstrial.com/share/singlenews/<?php echo e($newsdetails->id); ?>" id="myInput">
                                               ...
                                               <?php if(Auth::id() != $userdata->id): ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php if($prenews): ?>
                                                <a href="<?php echo e(URL::to('singlenews/'.$prenews->id)); ?>" class="btn btn-sm btn-success" style="position: absolute;bottom: -21px;right: 97px;">Previous News</a>
                                                <?php endif; ?>
                                                <?php if($nextnews): ?>
                                                <a href="<?php echo e(URL::to('singlenews/'.$nextnews->id)); ?>" class="btn btn-sm btn-success" style="position: absolute;bottom: -21px;right: 13px;">Next News</a>
                                                <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wu6wt82f25ae/public_html/recyclingmarketnewstrial.com/resources/views/dashboard/posts/singlenews.blade.php ENDPATH**/ ?>