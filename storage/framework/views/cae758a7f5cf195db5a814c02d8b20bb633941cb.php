	...
	<ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
			<a href="<?php echo e(URL::to('dash-what-can-publish')); ?>">
			    <i class="bx bx-info-circle icon nav-icon"></i>
				<span class="menu-item" data-key="t-calendar">What can publish?</span>
			</a>
		</li>
...
</div><?php /**PATH /home/wu6wt82f25ae/public_html/recyclingmarketnewstrial.com/resources/views/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>