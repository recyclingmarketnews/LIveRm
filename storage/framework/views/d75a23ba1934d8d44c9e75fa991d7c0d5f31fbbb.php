                       ...
                       <div class="text-center mb-4">
                        ...
                        <div class="card">
                            <div class="card-body p-4"> 
                                ...
                                <?php endif; ?>
                                <div class="p-2 mt-4">
                                    <form action="<?php echo e(URL::to('submit_registercompany')); ?>" id="submitform" method="post">
                                        <?php echo csrf_field(); ?>
                                    <div class="row">
...
<?php /**PATH /home/wu6wt82f25ae/public_html/recyclingmarketnews.com/resources/views/companysignup.blade.php ENDPATH**/ ?>