                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="single-footer footer-one">
                        ...
                        <ul class="bottom_links list-unstyled m-0">
                            ...
                            <li class="nav-item"><a href="<?php echo e(URL::to('/about')); ?>" class="nav-link">About Us</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('pricing')); ?>">Subscription</a></li>
    ...
    </div><?php /**PATH /home/wu6wt82f25ae/public_html/test.recyclingmarketnews.com/resources/views/partial/footer.blade.php ENDPATH**/ ?>