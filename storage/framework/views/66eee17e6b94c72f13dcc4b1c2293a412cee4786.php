                                    ...
                                    <div class="col-xl-4 mb-3">
                                        ...
                                        <div class="col-xl-12 mb-3">
                                            <div class="m-0 form-group">
                                              <label class="mb-2 fontsize14 form-label">Video Embed Link</label>
                                                <div id="youtubepreview" style="display: none;"></div>  
                                              <input name="videolink" id="videolink" type="text" class="transparent_form h-40px form-control inputstyle" value="">
                                            </div>
                                        </div>
...
<script>
  $( "#videolink" ).keyup(function() {
    ...
    original = $(this).val(); // inputed url
    var regExp = /^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#&?]*).*/;
    var match = original.match(regExp);
    var vid = (match&&match[7].length==11)? match[7] : false;
    video = "youtube"; // form id
    
    // Check if submitted input has value
    if (! original) {
      error.text('Input cannot be empty.')
    } else {
      $('#youtubepreview').css('display','block');
      $('#youtubepreview').html('<iframe src="https://youtube.com/embed/'+ vid + '" frameborder="0" allowfullscreen></iframe>');
    }
