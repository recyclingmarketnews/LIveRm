                                                    ...
                                                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                                      <div class="carousel-inner">
                                                        <div class="carousel-item active">
                                                                ...
                                                                <img style="border-radius:12px;" class="img-fluid object-cover w-100 center-block " src="<?php echo e(asset('uploads/post/'.$newsdetails->image)); ?>">
                                                                <?php elseif(!$newsdetails->image): ?>
                                                                <img style="border-radius:12px;" class="img-fluid object-cover w-100 center-block " src="<?php echo e(asset('uploads/post/'.$newsdetails->image)); ?>">
                                                                <?php else: ?>
                                                                 <img style="border-radius:12px;" class="img-fluid object-cover w-100 center-block " src="<?php echo e(asset('front/images/homenewscard.jpg')); ?>">
                                                                <?php endif; ?>                                                            
                                                        </div>
                                                        <?php if($newsdetails->image1 != ''): ?>
                                                        <div class="carousel-item">
                                                                <?php if($newsdetails->image1!="p.png"): ?>
                                                                <img style="border-radius:12px;" class="img-fluid object-cover w-100 center-block " src="<?php echo e(asset('uploads/post/'.$newsdetails->image1)); ?>">
                                                        ...
                                                        <div class="carousel-item">
                                                                ...
                                                                <img style="border-radius:12px;" class="img-fluid object-cover w-100 center-block " src="<?php echo e(asset('uploads/post/'.$newsdetails->image2)); ?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <input type="text" class="form-control" value="<?php echo e(URL::to('share/singlenews/'.$newsdetails->id)); ?>" id="myInput">
                        ...
                        <div class="card-comment mb-4 p-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="user-comment d-inline-flex flex-row align-items-center">
                                    ...
                                    <a href="<?php echo e(URL::to('viewprofile/'.$com->userid)); ?>"><small class="d-block font-weight-bold text-primary"><?php echo e($userdataa->fname.' '.$userdataa->lname); ?> &nbsp&nbsp&nbsp  <span class="stars mt-3 me-1" data-rating="<?php echo e($rating[0]->ratingval); ?>" data-num-stars="5" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="hover focus" data-bs-content="<?php echo e($rating[0]->ratingval); ?> out of 5"></span> <span class="mt-3">(<?php echo e($rating[0]->ratingval); ?>)</span></small> </a>
                                </div>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wu6wt82f25ae/public_html/globalrecyclingnews.net/resources/views/dashboard/posts/singlenews.blade.php ENDPATH**/ ?>