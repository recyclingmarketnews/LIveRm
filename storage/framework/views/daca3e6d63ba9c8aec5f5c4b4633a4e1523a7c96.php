                                ...
                                <div class="p-2 mt-4">
                                    <form action="<?php echo e(URL::to('submit_login')); ?>" method="post">
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="mb-0">Don't have an account ? <a href="<?php echo e(URL::to('signup')); ?>" class="fw-medium text-success"> Sign Up now </a> </p>
                                        </div>
                                    </form>
                                </div>
...
<?php /**PATH /home/wu6wt82f25ae/public_html/globalrecyclingnews.net/resources/views/login.blade.php ENDPATH**/ ?>