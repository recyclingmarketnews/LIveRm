                       ...
                       <div class="text-center mb-4">
                        ...
                        <div class="card">
                            <div class="card-body p-4"> 
                                ...
                                <?php endif; ?>
                                <div class="p-2 mt-4">
                                    <form action="<?php echo e(URL::to('submit_register')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="password" required name="cpassword" class="form-control" id="userpassword" placeholder="Enter confirm password">
                                        </div>
                                    
                                         <div class="col-lg-6 mb-3">
                                            <label class="form-label" for="userpassword">Subcription Type</label>
                                            <select class="form-select" name="subsriptiontype">
                                                <option>Select Subscription</option>
                                                <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php /**PATH /home/wu6wt82f25ae/public_html/globalrecyclingnews.net/resources/views/signup.blade.php ENDPATH**/ ?>