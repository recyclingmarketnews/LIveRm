                                            ...
                                            <div class="col-lg-7">
                                                <div class="title">
                                                   ...
                                                   <a href="#"><span class="badge badge-soft-warning  font-size-10" style="margin-left: 10px;" ><?php echo e($newsdetails->country); ?></span></a>
                                                    ...
                                                    <?php if($newsdetails->other_site_link != ''): ?>
                                                    <p>To access this story please click here: <a href="<?php echo e($newsdetails->other_site_link); ?>" target="abc" id="hideshow2"><?php echo e($newsdetails->other_site_link); ?></a></p>
                                                    <?php endif; ?>
                                                    ...
                                                    <ul class="list-unstyled mb-4 d-flex">
                                                        ...
                                                        <?php if($like == 1): ?>
                                                     <li class="pr-4 d-flex align-items-center "> <a class="btn btn-primary btn-sm me-3" href="<?php echo e(URL::to('unlike/'.$newsdetails->id)); ?>"><span class="bx bxs-heart"></span> <span><?php echo e($totallike); ?></span> like</a></li>
                                                        <?php else: ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\liverm\resources\views/dashboard/posts/singlenews.blade.php ENDPATH**/ ?>