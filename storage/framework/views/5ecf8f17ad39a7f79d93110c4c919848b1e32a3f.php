...
<div id="imageModalBox" class="imageModal">
  ...
  <div class="app-modal" data-name="delete" style="z-index: 999;">
          ...
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="<?php echo e(route('avatar.update')); ?>" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      <!--style="background-image: url('<?php echo e(Chatify::getUserWithAvatar(Auth::user())->avatar); ?>');"></div>-->
                      ...
                      <!--<p class="divider"></p>-->
                      <!--<p class="app-modal-header">Dark Mode <span class="<?php echo e(Auth::user()->dark_mode > 0 ? 'fa' : 'fa'); ?> fa-moon dark-mode-switch" data-mode="<?php echo e(Auth::user()->dark_mode > 0 ? 1 : 0); ?>"></span></p>-->
...
<?php /**PATH /home/wu6wt82f25ae/public_html/test.recyclingmarketnews.com/resources/views/vendor/Chatify/layouts/modals.blade.php ENDPATH**/ ?>