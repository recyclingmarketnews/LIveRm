...
<body class="page-overview ac-gn-current-overview">
    ...
    <main id="main" class="main" role="main" data-page-type="overview" style="background: #f1ecec73;">
...
<div class="container">
                <!-- row -->
                <div class="row">
                    <div class="col-lg-12 content-area order-lg-2" style="background: #fff;
    border-radius: 15px;
    margin-bottom: 14px;
    margin-top: 14px;">
                        <!-- ttm-service-single-content-are -->
                        <!-- ttm-service-single-content-are -->
                        <div class="ttm-service-single-content-area mt-3 mb-3">
                            <div class="ttm-service-description" style="text-align: justify; display: grid;">
                                <h3>TERMS & CONDITIONS</h3>
                            <a href ="{{ asset('front/pdffile/Terms _ Conditions - Recycling Market News.pdf')}}" attributes-list> Terms & Conditions</a>
                            <a href ="{{ asset('front/pdffile/Privacy Policy - Recycling Market News.pdf')}}" attributes-list> Privacy Policy </a>
                            <a href ="{{ asset('front/pdffile/Community Guidelines - Recycling Market News.pdf')}}" attributes-list> Community Guidelines</a> 
                            <a href ="{{ asset('front/pdffile/Content Takedown Policy - Recycling Market News.pdf')}}" attributes-list> Content Takedown Policy</a> 
                            <a href ="{{ asset('front/pdffile/Cookie Policy - Recycling Market News.pdf')}}" attributes-list> Cookie Policy</a>
                            <a href ="{{ asset('front/pdffile/Disclaimer - Recycling Market News.pdf')}}" attributes-list> Disclaimer</a>
                            <a href ="{{ asset('front/pdffile/Refund Policy - Recycling Market News.pdf')}}" attributes-list> Refund Policy</a> 
                            </div>
                        </div>
