                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-12 col-sm-12" style="margin-bottom: 5px; padding-left: 0;">
                                        <div class="d-flex  align-items-center">
                                            ...
                                            <span><a style="color:<?php if($mode == 'light'){ echo '#464545'; }else{ echo '#fff'; } ?>;font-size: 14px;font-weight: bold;" href="{{ URL::to('viewprofile/'.$userdata->id) }}" class="mb-1">{{ $userdata->fname.' '.$userdata->lname }} </a> </span>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-12 col-sm-12" style="margin-bottom: 5px; padding-left: 0;">
                                        <div class="d-flex  align-items-center">
                                            <span class="stars me-1 font-size-10" data-rating="{{ $rating[0]->ratingval }}" data-num-stars="5" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="hover focus" data-bs-content="{{ $rating[0]->ratingval }} out of 5"></span> <span class="font-size-10">({{ $rating[0]->ratingval }})</span>
                                            <span class="badge badge-soft-warning  font-size-10" style="margin-left: 10px;" >{{ $userdata->country }}</span>
                                            <span class="badge badge-soft-primary tooltipp  font-size-10" style="margin-left: 10px;">
                                                @php $specialarray = json_decode($userdata->specialist); $c = count($specialarray); @endphp
