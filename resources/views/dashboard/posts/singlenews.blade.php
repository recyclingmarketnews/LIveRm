                                                      ...
                                                      @if($newsdetails->videolink != '')
                                                        <div class="carousel-item active">
                                                            <iframe width="100%" height="315"
                                                                src="https://{{ $newsdetails->videolink }}">
                                                            </iframe>
                                                        </div>
                                                        @endif                                                        
                                                ...
                                                <div class="title">
                                                   ...
                                                   <a href="#"><span class="badge badge-soft-warning  font-size-10" style="margin-left: 10px;" >{{ $newsdetails->country }}</span></a>
                                                    ...
                                                    <ul class="list-unstyled mb-4 d-flex">
                                                        ...
                                                        @if($like == 1)
                                                     <li class="pr-4 d-flex align-items-center "> <a class="btn btn-primary btn-sm me-3" href="{{ URL::to('unlike/'.$newsdetails->id) }}"><span class="bx bxs-heart"></span> <span>{{ $totallike }}</span> like</a></li>
                                                        @else
                                                        ...
                                                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                          <div class="modal-dialog">
                                                            <div class="modal-content">
                                                              ...
                                                              <div class="modal-body mb-2 mt-3">
                                                                    ...
                                                                    <div class ="frame">
                                                                            ...
                                                                            <a target="_blank" href="https://www.facebook.com/sharer.php?u={{ URL::to('share/'.$newsheading) }}" class="btnshare">
                                                                                <i class="fa fa-facebook-f" style="color: #3b5998;"></i>
                                                                            </a>
                                                                            <p class="mt-2">Facebook</p>
                                                                            </div>
                                                                            <div  class="text-center">
                                                                                <a  target="_blank" href="https://twitter.com/intent/tweet?url={{ URL::to('share/'.$newsheading) }}&text={{ $newsdetails->heading }}" class="btnshare">
                                                                                    <i class="fa fa-twitter" style="color: #00acee;"></i>
                                                                                </a>
                                                                                <p  class="mt-2">Twitter</p>                                                                          
                                                                            </div>
                                                                            <div  class="text-center">
                                                                                <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url={{ URL::to('share/'.$newsheading) }}" class="btnshare">
                                                                    ...
                                                                    <input type="text" class="form-control d-none" value="{{ URL::to('share/'.$newsheading) }}" id="myInput">
                                                              </div>
