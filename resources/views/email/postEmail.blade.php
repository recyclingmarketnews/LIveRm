																							...
																							<tr>
																								<td align="left" valign="top" class="r20-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 18px; line-height: 1.5; text-align: left; word-wrap: break-word;">
																									<div>
																										...
																										<p style="margin: 0;"> </p>
																										<p style="margin: 0;"><span style="font-family: 'Times new roman', times, serif; font-size: 15px;">New news has been published by {{ $namee }}. </span></p>
																										
																										<p style="margin: 0;"> </p>
																										<p style="margin: 0;"><span style="font-family: 'Times new roman', times, serif; font-size: 15px;">.</span>News <a href="{{ URL::to('singlenews/'.$postid) }}">Link</a></p>
																										<p style="margin: 0;"> </p>
