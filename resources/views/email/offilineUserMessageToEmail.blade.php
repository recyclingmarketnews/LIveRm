																						...
																						<table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r14-o" style="table-layout: fixed; width: 100%;">
																							...
																							<tr>
																								<td align="left" valign="top" class="r20-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 18px; line-height: 1.5; text-align: left; word-wrap: break-word;">
																									<div>
																									    <!--<img src="{{ asset('front/images/embedcolor.png')}}" width="51" border="0" class="" style="display: block; width: 100%; text-align: center;">-->
																										<!--<p style="margin: 0;"><span style="font-family: 'Times new roman', times, serif; font-size: 15px; text-align: center;">{{ $fromusername ?? '' }} has sent you a message</span></p>-->
																										<p style="margin: 0;"></p>
																										<p style="margin: 0;"><span style="font-family: 'Times new roman', times, serif; font-size: 13px;">Dear {{ $tousername ?? '' }},</span></p>
																										<br>
																										<p style="margin: 0;"><span style="font-family: 'Times new roman', times, serif; font-size: 14px;">{{ $fromusername ?? '' }}  sent the following message on RM News.</span></p>
																										<p style="margin: 0;"></p>
																										<p style="margin: 0;"><span style="font-family: 'Times new roman', times, serif; font-size: 13px; color:#1cbd82;">"{{ $msg ?? '' }}"</span></p>
																										<p style="margin: 0;"></p>
																										<br>
