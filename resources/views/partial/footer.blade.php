            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="single-footer footer-one">
                        ...
                        <div class="footer-logo"><img class="img-fluid" src="{{ asset('front/images/logo-white.png')}}" width="280px" /></div>
                        <p>Market news by recycler for recyclers! </p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="single-footer footer-one">
                        ...
                        <ul class="bottom_links list-unstyled m-0">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ URL::to('pricing') }}">Subscription</a></li>
                            <li class="nav-item"><a href="{{ URL::to('term') }}" class="nav-link">Terms & Conditions</a></li>
                            <li class="nav-item"><a href="{{ URL::to('contact') }}" class="nav-link">Contact Us</a></li>
                        </ul>
                    </div>
                </div>
                <!--  -->
                    ...
                    <div class="single-footer footer-one">
                        ...
                        <div class="footer-three">
                            <ul class="list-unstyled">
                                <li>
                                    <!--<a href="#"><img class="img-fluid" src="{{ asset('front/images/1.png')}}" alt="flicker photo"></a>-->
                                </li>
                            </ul>
                        </div>
                    </div>
