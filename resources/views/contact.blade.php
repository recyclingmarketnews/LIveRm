...
<section class="ttm-row zero-padding-section clearfix">
                    ...
                    <div class="row no-gutters"><!-- row -->
                        <div class="col-lg-12">
                            <div class="spacing-10 ttm-bgcolor-grey ttm-bg ttm-col-bgcolor-yes ttm-right-span">
                                ...
                                <form id="ttm-quote-form" class="row ttm-quote-form clearfix" method="post" action="{{ URL::to('submitcontact') }}">
                                    @csrf
    ...
    <script type="text/javascript" src="{{ asset('front/localeswitcher.built.js')}}"></script>
